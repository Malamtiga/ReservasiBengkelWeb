	...
	<div class="row">
		<div class="col-md-4">
			<div class="card">
				...
				<img  class="img-fluid rounded-circle mb-3" src="<?= base_url() . "/uploads/pengguna/".'/'. $user['foto'] ?>">
			
					<h5 class="card-title"><?php echo $user['nama']; ?></h5>
					<p class="card-text"><?php echo $user['username']; ?></p>
					<form action="<?= base_url('pengguna/profile/upload'); ?>" method="post" enctype="multipart/form-data">
